...
$(function() {
    ...
    function generateFlower() {
        ...
        while(previousRadius <= 1.0) {
            ...
            var colorPrimary = COLOURS[Math.floor(previousRadius * COLOURS.length)];
            colorPrimary = 'rgb('+colorPrimary[0]+','+colorPrimary[1]+','+colorPrimary[2]+')';
    ...
    ctx.update = function() {
        for(k = 0; k < flowers.length; ++k) {
            ...
            for( var j = 0; j < flower.length; ++j ) {
                ...
                var _x = 2.012 * _l.x_0 - _l.x_1 + _f * dt * dt;
